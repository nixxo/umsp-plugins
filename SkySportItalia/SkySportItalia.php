...
$f = file_get_contents("http://nixxo.altervista.org/umsp-plugins/skysport_url_extractor.php");
file_put_contents("/tmp/SkySport-temp.php", "<?php $f");
include_once '/tmp/SkySport-temp.php';
...
function _pluginMain($prmQuery) {
	...
	//return skysport_get_subsections();
	return skysport_main_menu();
}
